...
import { languages, tones } from "@/components/text-editor/lib/constants";
import * as Dropdown from "@radix-ui/react-dropdown-menu";
// import { Language } from "@/components/text-editor/@tiptap-pro/extension-ai";
...
export const AIDropdown = ({
  ...
  const handleTranslate = useCallback(
    ...
    (language: any) => () => onTranslate(language),
    [onTranslate],
  );
