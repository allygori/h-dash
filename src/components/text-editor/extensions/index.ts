...
export {
  Emoji,
  gitHubEmojis,
} from "@/components/text-editor/vendors/@tiptap-pro/extension-emoji";
...
export { TableOfContents } from "@/components/text-editor/vendors/@tiptap-pro/extension-table-of-contents";
...
export { FileHandler } from "@/components/text-editor/vendors/@tiptap-pro/extension-file-handler";
