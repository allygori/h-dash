          ...
          content: [
            {
              ...
              content: [
                {
                  type: "text",
                  text: "@/components/text-editor/vendors/@tiptap-pro/extension-drag-handle",
                },
              ],
            },
          ],
          ...
          content: [
            {
              ...
              content: [
                {
                  type: "text",
                  text: "@/components/text-editor/vendors/@tiptap-pro/extension-drag-handle-react",
                },
              ],
            },
          ],
          ...
          content: [
            {
              ...
              content: [
                {
                  type: "text",
                  text: "@/components/text-editor/vendors/@tiptap-pro/extension-emoji",
                },
              ],
            },
          ],
          ...
          content: [
            {
              ...
              content: [
                {
                  type: "text",
                  text: "@/components/text-editor/vendors/@tiptap-pro/extension-file-handler",
                },
              ],
            },
          ],
          ...
          content: [
            {
              ...
              content: [
                {
                  type: "text",
                  text: "@/components/text-editor/vendors/@tiptap-pro/extension-mathematics",
                },
              ],
            },
          ],
          ...
          content: [
            {
              ...
              content: [
                {
                  type: "text",
                  text: "@/components/text-editor/vendors/@tiptap-pro/extension-node-range",
                },
              ],
            },
          ],
          ...
          content: [
            {
              ...
              content: [
                {
                  type: "text",
                  text: "@/components/text-editor/vendors/@tiptap-pro/extension-table-of-contents",
                },
              ],
            },
          ],
          ...
          content: [
            {
              ...
              content: [
                {
                  type: "text",
                  text: "@/components/text-editor/vendors/@tiptap-pro/extension-unique-id",
                },
              ],
            },
          ],
